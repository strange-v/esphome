...
# MaTouch ESP32‑P4 TFT with Touch 7" (MaTouch‑E32P4MI71)
# Panel IC: JD9165 (MIPI‑DSI DPI), native 1024x600
#
#
...
DriverChip(
    ...
    color_order="BGR",
    initsequence=[
        # Page 0 + vendor unlock
        (0x30, 0x00),
        (0xF7, 0x49, 0x61, 0x02, 0x00),
        # Page 1: base power/system and interface/polarities + drive/scan enables
        (0x30, 0x01),
        (0x04, 0x0C),
        (0x05, 0x00),
        (0x06, 0x00),
        ...
        (0x18, 0x99),
        # Page 6: extended correction tables
        (0x30, 0x06),
        (
            0x12,
            0x36,
        ...
        # Page 0x0A: clocks/PLL (target/fast)
        (0x30, 0x0A),
        (0x02, 0x4F),
        (0x0B, 0x40),
        (0x12, 0x3E),
        (0x13, 0x78),
        # Page 0x0D: timing fixups
        (0x30, 0x0D),
        (0x0D, 0x04),
        (0x10, 0x0C),
        (0x11, 0x0C),
        (0x12, 0x0C),
        (0x13, 0x0C),
        # Back to DCS domain + exit sleep + display on
        (0x30, 0x00),
        (0x11,),  # Sleep OUT
        (0x29,),  # Display ON
    ],
